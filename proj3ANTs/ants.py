...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        # myplace = self.place
        # while not myplace.is_hive:
        #     if myplace.bees:
        #         return random_bee(myplace.bees)
        #     myplace = myplace.entrance
        # return None
        # END Problem 3 and 4
        def find_nearest(myplace, step):
            if myplace.is_hive: # Basecase hive returns None
                return None
            ...
            if step < self.min_range: # If 'place' is still within the minimum range, return recursive calls
                return find_nearest(myplace.entrance, step + 1)
...
class GameState:
    ...
    def __init__(self, strategy, beehive, ant_types, create_places, dimensions, food=2):
        ...
        self.queen_exists = False  # Helper instance variable 
